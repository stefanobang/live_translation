...
작성자는 제공된 정보에 대해 어떠한 보증도 하지 않으며 사용으로 인한 손해에 대한 책임도 지지 않습니다. 
소프트웨어는 상품성에 대한 보증을 포함하지만 이에 국한되지 않는 명시적 또는 묵시적 보증 없이 "있는 그대로" 제공됩니다.
어떠한 경우에도 작성자 또는 저작권 소유자는 소프트웨어 또는 소프트웨어의 사용 또는 기타 거래에서 발생하는 계약, 
불법행위 또는 기타 행위에 관계없이 모든 청구, 손해 또는 기타 책임에 대해 책임을 지지 않습니다.
